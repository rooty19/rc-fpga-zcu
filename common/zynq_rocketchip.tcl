...
if {[string equal [get_runs -quiet synth_1] ""]} {
  #Tuo change flow from 2015 to 2020
  create_run -name synth_1 -part PART_NUMBER_HERE -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part PART_NUMBER_HERE -flow {Vivado Implementation 2020} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
